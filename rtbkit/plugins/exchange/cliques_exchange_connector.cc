/* cliques_exchange_connector.cc
   Ben Liang, 24 March 2015
   Copyright (c) 2014 Datacratic.  All rights reserved.
   
   Implementation of the Cliques Exchange Connector
*/

#include "cliques_exchange_connector.h"
...
void CliquesExchangeConnector::initCreativeConfiguration()
{
...
double
CliquesExchangeConnector::getTimeAvailableMs(
...
CliquesExchangeConnector::getCampaignCompatibility(
...
ExchangeConnector::ExchangeCompatibility
CliquesExchangeConnector::getCreativeCompatibility(
...
CliquesExchangeConnector::parseBidRequest(
        HttpAuctionHandler& handler,
        const HttpHeader& header,
        const std::string& payload)
{
...
void
CliquesExchangeConnector::setSeatBid(
    ...
    CliquesCreativeConfiguration::Context context {
        creative,
        resp,
        *auction.request,
        spotNum
...
struct Init {
    Init() {
        RTBKIT::ExchangeConnector::registerFactory<CliquesExchangeConnector>();
    }
};
